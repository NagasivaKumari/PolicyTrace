...
If blockd-contracts MCP is installed, use its GitHub tools to find working code:
...
2. `algorandfoundation/puya-ts` — Advanced TypeScript examples
   - `examples/blockd-audit/`, `examples/blockd-certificate/`
...
### Blockchain Interaction (BLOCKD MCP)
